...
class TissueProcessEmbed extends DataRecordBaseClass {
    
    CaseRecord caseRecord
    //String expKeyBarcodeId        // #1
    //SOPRecord processingSOP    
    String processingSOP         // #3-#1
    String tissProcessorMdl         // #2
    String othTissProcessorMdl      // #2-other
    ...
    static mapping = {
        table 'form_tissue_process_embed'
        id generator:'sequence', params:[sequence:'form_tissue_process_embed_pk']
    }
