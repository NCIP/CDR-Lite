    ...
    def sendActivityEventEmail(recipient, emailSubject, emailBody) {
        try {
            ...
            if(recipient) {
                ...
                log.warn("Service Mail Not Sent: No recipient found!" + " :: recip=" + recipient + ", subj=" + emailSubject + ", body=" + emailBody)
            }
        } catch (Exception e) {
            throw new RuntimeException("Service Mail Not Sent: " +e.toString() + " :: recip=" + recipient + ", subj=" + emailSubject + ", body=" + emailBody)
        }
    }
