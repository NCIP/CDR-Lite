        ...
        <g:if test="${therapyRecord.typeOfTherapy == 'HBC'}">
          ...
          <g:else>
              ...
              <tr id="hbcAddNew" class="hide" >
                 <td><g:select name="formHorBirthControl" from="${nci.bbrb.cdr.forms.TherapyRecord$HBCForm?.values()}" keys="${nci.bbrb.cdr.forms.TherapyRecord$HBCForm?.values()*.name()}" /></td>
