		    ...
		    <g:formatDate date="${therapyRecord.therapyDate}" format="MM/dd/yyyy" />${therapyRecord.howLongAgo}
              ...
              <tr class="prop hide" id="hormTherb4SurgDescRow">
                <td colspan="3" class="subform"> 
                  <div class="subformquestion clearfix ${hasErrors(bean: clinicalDataEntryInstance, field: 'hormTherb4SurgDesc', 'errors')}">
                  ...
                  <div class="subformquestion clearfix ${hasErrors(bean: clinicalDataEntryInstance, field: 'hormTherb4SurgDt', 'errors')}">
