        ...
        <g:if test="${therapyRecord.typeOfTherapy == 'chemo'}">
          ...
          <g:else>
              <tr class="odd" id="chemo_${therapyRecord.id}">
                ...
                <td class="textcenter">
		    <g:if test="${(session.LDS != null && session.LDS == true) || params.action != 'show'||session.DM == true}">
			...
			<span class="redactedMsg">REDACTED (No LDS privilege)</span>
              ...
              <tr class="prop hide" id="chemoTherb4SurgDescRow">
                <td colspan="3" class="subform"> 
                  <div class="subformquestion clearfix ${hasErrors(bean: clinicalDataEntryInstance, field: 'chemoTherb4SurgDesc', 'errors')}">
                  ...
                  <div class="subformquestion clearfix ${hasErrors(bean: clinicalDataEntryInstance, field: 'chemoTherb4SurgDt', 'errors')}">
