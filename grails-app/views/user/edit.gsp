	...
	<s2ui:tab name='userinfo' height='275'>
		...
		<tbody>
			...
			<s2ui:checkboxRow name='passwordExpired' labelCode='user.passwordExpired.label' bean="${user}"
                      ...
                      <td valign="top" >
                     <%-- <g:select  name="organization.id" from="${nci.bbrb.cdr.staticmembers.Organization.list().sort{it.code}}" optionKey="id" value="${user?.organization?.id}"  />--%>
                       <g:select  name="organization.id" from="${nci.bbrb.cdr.staticmembers.Organization.list().sort{it.name}}" optionKey="id" optionValue="name" value="${user?.organization?.id}"  />
                       </td>
                      </tr>
		</tbody>
		</table>
