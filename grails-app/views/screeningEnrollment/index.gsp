                            ...
                            <tbody>
                                <g:each in="${screeningEnrollmentInstanceList}" status="i" var="screeningEnrollmentInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td><g:link action="show" id="${screeningEnrollmentInstance.id}">${fieldValue(bean: screeningEnrollmentInstance, field: "candidateRecord")}</g:link></td>
                                        
                                        <td>${fieldValue(bean: screeningEnrollmentInstance, field: "nameCreateCandidate")}</td>
                                        
                                        <td><g:formatBoolean boolean="${screeningEnrollmentInstance.metCriteria}" /></td>
