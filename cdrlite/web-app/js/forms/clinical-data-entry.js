...
/*        $("#formHorReplaceTher").change(function() {
      ...
      $( "#prevCancerSaveBtn" ).button().click(function() {
                if ((($( "#prevCancerDiagDesc" ).val()) == '') && (($( "#prevCancerDiagDt" ).val()) == '') && (($( "#prevCancerDiagEst" ).val()) == '')) {
                  ...
                  $("#prevCancerDiagDesc").focus();                  
                  return false;
                }else if ((($( "#prevCancerDiagDt" ).val()) == '') && (($( "#prevCancerDiagEst" ).val()) == '')) {
      ...
      $( "#irradSaveBtn" ).button().click(function() {
                if ((($( "#irradTherb4SurgDesc" ).val()) == '') && (($( "#irradTherb4SurgDt" ).val()) == '') && (($( "#irradTherb4SurgEst" ).val()) == '')) {
                  ...
                  $("#irradTherb4SurgDesc").focus();                  
                  return false;
                }else if ((($( "#irradTherb4SurgDt" ).val()) == '') && (($( "#irradTherb4SurgEst" ).val()) == '')) {
      ...
      $( "#chemoSaveBtn" ).button().click(function() {
                if ((($( "#chemoTherb4SurgDesc" ).val()) == '') && (($( "#chemoTherb4SurgDt" ).val()) == '') && (($( "#chemoTherb4SurgEst" ).val()) == '')) {
                  ...
                  $("#chemoTherb4SurgDesc").focus();                  
                  return false;
                }else if ((($( "#chemoTherb4SurgDt" ).val()) == '') && (($( "#chemoTherb4SurgEst" ).val()) == '')) {
      ...
      $( "#immSaveBtn" ).button().click(function() {
                if ((($( "#immTherb4SurgDesc" ).val()) == '') && (($( "#immTherb4SurgDt" ).val()) == '') && (($( "#immTherb4SurgEst" ).val()) == '')) {
                  ...
                  $("#immTherb4SurgDesc").focus();                  
                  return false;
                }else if ((($( "#immTherb4SurgDt" ).val()) == '') && (($( "#immTherb4SurgEst" ).val()) == '')) {
      ...
      $( "#hormSaveBtn" ).button().click(function() {
                if ((($( "#hormTherb4SurgDesc" ).val()) == '') && (($( "#hormTherb4SurgDt" ).val()) == '') && (($( "#hormTherb4SurgEst" ).val()) == '')) {
                  ...
                  $("#hormTherb4SurgDesc").focus();                  
                  return false;
                }else if ((($( "#hormTherb4SurgDt" ).val()) == '') && (($( "#hormTherb4SurgEst" ).val()) == '')) {
