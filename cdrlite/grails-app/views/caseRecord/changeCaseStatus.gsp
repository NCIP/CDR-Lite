                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top">
                                 ...
                                 <g:link controller="caseRecord" action="show" id="${caseRecordInstance.id}">${caseRecordInstance.caseId}</g:link> 
                                </td>
                            </tr>                          
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean: caseRecordInstance, field: 'caseRecord', 'errors')}">
                                  <g:if test="${session.org.code == 'DCC'}">
                                    <g:select name="caseStatus.id" from="${nci.bbrb.cdr.staticmembers.CaseStatus.list()}" optionKey="id" value="${caseRecordInstance?.caseStatus?.id}"  />
                                  </g:if>                                    
                                  <g:else>
