          ...
          <g:else>
            ...
            <tr class="prop hide" id="immTherb4SurgDescRow">
              <td colspan="3" class="subform">
                <div class="subformquestion clearfix ${hasErrors(bean: clinicalDataEntryInstance, field: 'immTherb4SurgDesc', 'errors')}">
                ...
                <div class="subformquestion clearfix ${hasErrors(bean: clinicalDataEntryInstance, field: 'immTherb4SurgDt', 'errors')}">
