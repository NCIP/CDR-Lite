        ...
        <div id="nav" class="clearfix">
            <div id="navlist">
                <a class="home" href="${createLink(uri: '/')}"><g:message code="default.home.label"/></a>
                    <g:link class="list" action="list" id="${cancerHistoryInstance.candidateRecord?.id}"><g:message code="default.list.label" args="[entityName]" /></g:link>
                       </div>
                       </div>
                    ...
                    <g:form url="[resource:cancerHistoryInstance, action:'save']" >
                         <g:hiddenField name="candidateRecord.id" value="${cancerHistoryInstance?.candidateRecord?.id}" />
                        <div class="dialog">
